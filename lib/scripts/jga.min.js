...
this.nextButton.css("visibility","visible");this.slide();return false;},'.next':function(element,event){if(this._currentPage<this._totalPages)
...
this.prevButton.css("visibility","visible");this.slide();return false;}}),slide:function(){$("ul",this.element).animate({"left":-(this._currentPage-1)*(this.options.elementWidth*this.options.numberPerPage)});}},{elementWidth:100,numberPerPage:1});})(jQuery);
